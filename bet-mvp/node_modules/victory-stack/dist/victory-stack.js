...
function stackData(props, childComponents) {
  var dataFromChildren = victory_core__WEBPACK_IMPORTED_MODULE_3__.getDataFromChildren(props, childComponents);
...
function getCalculatedProps(initialProps, childComponents) {
  var children = childComponents || react__WEBPACK_IMPORTED_MODULE_1___default().Children.toArray(initialProps.children);
  var role = "stack";
  var props = victory_core__WEBPACK_IMPORTED_MODULE_4__.modifyProps(initialProps, fallbackProps, role);
  var style = victory_core__WEBPACK_IMPORTED_MODULE_3__.getStyle(props.theme, props.style, role);
  var categories = props.categories || victory_core__WEBPACK_IMPORTED_MODULE_3__.getCategories(props, children);
...
var withoutSharedEvents = function (props) {
  ...
  var modifiedChildren = react__WEBPACK_IMPORTED_MODULE_1___default().Children.toArray(children).map(function (_child) {
    var child = _child;
...
function getChildren(initialProps, childComponents, calculatedProps) {
  var props = victory_core__WEBPACK_IMPORTED_MODULE_4__.modifyProps(initialProps, fallbackProps, "stack");
  ...
  return children.map(function (child, index) {
    ...
    var style = victory_core__WEBPACK_IMPORTED_MODULE_3__.getChildStyle(child, index, newCalculatedProps);
