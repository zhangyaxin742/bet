...
var getData = function (props) {
  ...
  var generatedData = props.errorX || props.errorY ? victory_core__WEBPACK_IMPORTED_MODULE_2__.generateData(props) : [];
...
var formatDataFromDomain = function (datum, domain) {
  var minDomainX = victory_core__WEBPACK_IMPORTED_MODULE_4__.getMinValue(domain.x);
  var maxDomainX = victory_core__WEBPACK_IMPORTED_MODULE_4__.getMaxValue(domain.x);
  var minDomainY = victory_core__WEBPACK_IMPORTED_MODULE_4__.getMinValue(domain.y);
  var maxDomainY = victory_core__WEBPACK_IMPORTED_MODULE_4__.getMaxValue(domain.y);
  var _x = datum._x,
...
var getCalculatedValues = function (props) {
  var defaultStyles = victory_core__WEBPACK_IMPORTED_MODULE_5__.getDefaultStyles(props, "errorbar");
  var style = victory_core__WEBPACK_IMPORTED_MODULE_5__.getStyles(props.style, defaultStyles) || {};
  ...
  var origin = props.polar ? props.origin || victory_core__WEBPACK_IMPORTED_MODULE_5__.getPolarOrigin(props) : undefined;
  return {
    domain: domain,
    data: data,
    scale: scale,
...
var getBaseProps = function (initialProps, fallbackProps) {
  var modifiedProps = victory_core__WEBPACK_IMPORTED_MODULE_5__.modifyProps(initialProps, fallbackProps, "errorbar");
  ...
  return data.reduce(function (childProps, datum, index) {
    var eventKey = !victory_core__WEBPACK_IMPORTED_MODULE_5__.isNil(datum.eventKey) ? datum.eventKey : index;

    var _Helpers$scalePoint = victory_core__WEBPACK_IMPORTED_MODULE_5__.scalePoint(lodash_assign__WEBPACK_IMPORTED_MODULE_0___default()({}, props, {
      scale: scale
    }), datum),
...
/* harmony import */ var _error_bar__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./error-bar */ "./error-bar.tsx");
...
VictoryErrorBarBase.defaultProps = {
  ...
  data: defaultData,
  dataComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_error_bar__WEBPACK_IMPORTED_MODULE_5__.ErrorBar, null),
...
VictoryErrorBarBase.getDomain = _helper_methods__WEBPACK_IMPORTED_MODULE_8__.getDomain;
VictoryErrorBarBase.getData = _helper_methods__WEBPACK_IMPORTED_MODULE_8__.getData;
...
var VictoryErrorBar = (0,victory_core__WEBPACK_IMPORTED_MODULE_9__.addEvents)(VictoryErrorBarBase);
