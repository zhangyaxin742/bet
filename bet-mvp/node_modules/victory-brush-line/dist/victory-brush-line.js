...
var getScale = function (props) {
  ...
  var fallbackScale = victory_core__WEBPACK_IMPORTED_MODULE_4__.getBaseScale(props, dimension);
  var range = victory_core__WEBPACK_IMPORTED_MODULE_5__.getRange(props, dimension);
  var domain = victory_core__WEBPACK_IMPORTED_MODULE_6__.getDomainFromProps(props, dimension) || [0, 1];
...
var getBrushDomain = function (brushDomain, fullDomain) {
  if (brushDomain) {
    var brushMin = victory_core__WEBPACK_IMPORTED_MODULE_7__.getMinValue(brushDomain);
    var brushMax = victory_core__WEBPACK_IMPORTED_MODULE_7__.getMaxValue(brushDomain);
    var domainMin = victory_core__WEBPACK_IMPORTED_MODULE_7__.getMinValue(fullDomain);
    var domainMax = victory_core__WEBPACK_IMPORTED_MODULE_7__.getMaxValue(fullDomain);
...
var VictoryBrushLine = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(VictoryBrushLine, [{
    ...
    value: function renderBrush(props) {
      ...
      var style = victory_core__WEBPACK_IMPORTED_MODULE_5__.evaluateStyle(baseStyle, {
        datum: datum,
  ...
  return props.disable ? undefined : [{
    ...
    eventHandlers: {
      onMouseEnter: function (evt, targetProps) {
        ...
        var parentSVG = targetProps.parentSVG || victory_core__WEBPACK_IMPORTED_MODULE_10__.getParentSVG(evt);
        var position = victory_core__WEBPACK_IMPORTED_MODULE_10__.getSVGEventCoordinates(evt, parentSVG)[dimension];
