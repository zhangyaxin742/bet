...
function nativeBrushMixin(Base) {
  ...
  return _class = /*#__PURE__*/function (_Base) {
    _inherits(VictoryNativeBrushContainer, _Base);

    var _super = _createSuper(VictoryNativeBrushContainer);

    function VictoryNativeBrushContainer() {
      _classCallCheck(this, VictoryNativeBrushContainer);

      return _super.apply(this, arguments);
    }

    return _createClass(VictoryNativeBrushContainer);
  }(Base), _class.defaultProps = _objectSpread(_objectSpread({}, _victoryBrushContainer.VictoryBrushContainer.defaultProps), {}, {
...
var combinedMixin = (0, _flow2.default)(_victoryBrushContainer.brushContainerMixin, nativeBrushMixin);
...
var VictoryBrushContainer = brushContainerMixin(_victoryContainer.VictoryContainer);
