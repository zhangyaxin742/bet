...
function nativeVoronoiMixin(Base) {
  ...
  return _class = /*#__PURE__*/function (_Base) {
    _inherits(VictoryNativeVoronoiContainer, _Base);

    var _super = _createSuper(VictoryNativeVoronoiContainer);

    function VictoryNativeVoronoiContainer() {
      _classCallCheck(this, VictoryNativeVoronoiContainer);

      return _super.apply(this, arguments);
    }

    return _createClass(VictoryNativeVoronoiContainer);
  }(Base), _class.defaultProps = _objectSpread(_objectSpread({}, _victoryVoronoiContainer.VictoryVoronoiContainer.defaultProps), {}, {
    activateData: true,
    activateLabels: true,
...
var combinedMixin = (0, _flow2.default)(_victoryVoronoiContainer.voronoiContainerMixin, nativeVoronoiMixin);
...
var VictoryVoronoiContainer = voronoiContainerMixin(_victoryContainer.VictoryContainer);
