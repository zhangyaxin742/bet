...
/* harmony export */   "combineContainerMixins": () => (/* binding */ combineContainerMixins),
/* harmony export */   "createContainer": () => (/* binding */ createContainer),
/* harmony export */   "makeCreateContainerFunction": () => (/* binding */ makeCreateContainerFunction)
/* harmony export */ });
...
var combineEventHandlers = function (eventHandlersArray) {
  ...
  return eventHandlersArray.reduce(function (localHandlers, finalHandlers) {
    lodash_forOwn__WEBPACK_IMPORTED_MODULE_2___default()(localHandlers, function (localHandler, eventName) {
...
var combineDefaultEvents = function (defaultEvents) {
  ...
  var eventsByTarget = lodash_groupBy__WEBPACK_IMPORTED_MODULE_3___default()(defaultEvents, "target");

  var events = lodash_toPairs__WEBPACK_IMPORTED_MODULE_4___default()(eventsByTarget).map(function (_ref) {
...
var combineContainerMixins = function (mixins, Container) {
  ...
  var NaiveCombinedContainer = lodash_flow__WEBPACK_IMPORTED_MODULE_1___default()(mixins)(Container);
  ...
  return _class = /*#__PURE__*/function (_NaiveCombinedContain) {
    ...
    return combineDefaultEvents(Classes.reduce(function (defaultEvents, Class) {
      var events = victory_core__WEBPACK_IMPORTED_MODULE_5__.isFunction(Class.defaultEvents) ? Class.defaultEvents(props) : Class.defaultEvents;
...
var checkBehaviorName = function (behavior, behaviors) {
  if (behavior && !behaviors.includes(behavior)) {
    victory_core__WEBPACK_IMPORTED_MODULE_6__.warn("\"".concat(behavior, "\" is not a valid behavior. Choose from [").concat(behaviors.join(", "), "]."));
  }
};
...
var Helpers = {
  ...
  withinBounds: function (point, bounds, padding) {
    var _CoreHelpers$mapValue = victory_core__WEBPACK_IMPORTED_MODULE_3__.mapValues(bounds, Number),
        x1 = _CoreHelpers$mapValue.x1,
        x2 = _CoreHelpers$mapValue.x2,
        y1 = _CoreHelpers$mapValue.y1,
        y2 = _CoreHelpers$mapValue.y2;

    var _CoreHelpers$mapValue2 = victory_core__WEBPACK_IMPORTED_MODULE_3__.mapValues(point, Number),
  ...
  getDomainBox: function (props, fullDomain, selectedDomain) {
    ...
    var fullDomainObject = lodash_defaults__WEBPACK_IMPORTED_MODULE_0___default()({}, fullDomain, props.domain);

    var selectedDomainObject = lodash_defaults__WEBPACK_IMPORTED_MODULE_0___default()({}, selectedDomain, fullDomainObject);

    var fullCoords = victory_core__WEBPACK_IMPORTED_MODULE_4__.getDomainCoordinates(props, fullDomainObject);
    var selectedCoords = victory_core__WEBPACK_IMPORTED_MODULE_4__.getDomainCoordinates(props, selectedDomainObject);
    return {
  ...
  getDefaultBrushArea: function (targetProps, cachedDomain, evt) {
    ...
    if (defaultBrushArea === "none") {
      ...
      var parentSVG = targetProps.parentSVG || victory_core__WEBPACK_IMPORTED_MODULE_4__.getParentSVG(evt);
      ...
      return victory_core__WEBPACK_IMPORTED_MODULE_4__.getBounds(_objectSpread(_objectSpread({}, constrainedBox), {}, {
        scale: scale,
  ...
  panBox: function (props, point) {
    ...
    var brushDomain = lodash_defaults__WEBPACK_IMPORTED_MODULE_0___default()({}, props.brushDomain, domain);

    var fullDomain = lodash_defaults__WEBPACK_IMPORTED_MODULE_0___default()({}, props.fullDomain, domain);
  ...
  constrainBox: function (box, fullDomainBox) {
    var _CoreHelpers$mapValue3 = victory_core__WEBPACK_IMPORTED_MODULE_3__.mapValues(fullDomainBox, Number),
  ...
  constrainPoint: function (point, fullDomainBox) {
    var _CoreHelpers$mapValue4 = victory_core__WEBPACK_IMPORTED_MODULE_3__.mapValues(fullDomainBox, Number),
  ...
  onMouseDown: function (evt, targetProps) {
    ...
    var _Selection$getSVGEven = victory_core__WEBPACK_IMPORTED_MODULE_4__.getSVGEventCoordinates(evt, parentSVG),
    ...
    var brushDomain = lodash_defaults__WEBPACK_IMPORTED_MODULE_0___default()({}, targetProps.brushDomain, domain);

    var currentDomain = react_fast_compare__WEBPACK_IMPORTED_MODULE_2___default()(brushDomain, cachedBrushDomain) ? targetProps.currentDomain || brushDomain || domain : brushDomain || domain;
  ...
  onGlobalMouseMove: function (evt, targetProps) {
    ...
    var _Selection$getSVGEven2 = victory_core__WEBPACK_IMPORTED_MODULE_4__.getSVGEventCoordinates(evt, parentSVG),
    ...
    if (allowDrag && isPanning) {
      ...
      var constrainedBox = this.constrainBox(pannedBox, fullDomainBox);
      var currentDomain = victory_core__WEBPACK_IMPORTED_MODULE_4__.getBounds(_objectSpread(_objectSpread({}, constrainedBox), {}, {
        scale: scale,
        horizontal: horizontal
      }));
      ...
      var _currentDomain = victory_core__WEBPACK_IMPORTED_MODULE_4__.getBounds({
        x2: x2,
        y2: y2,
        x1: targetProps.x1,
        y1: targetProps.y1,
      ...
      if (victory_core__WEBPACK_IMPORTED_MODULE_3__.isFunction(onBrushDomainChange)) {
        onBrushDomainChange(_currentDomain, lodash_defaults__WEBPACK_IMPORTED_MODULE_0___default()({}, _mutatedProps, targetProps));
      }
...
var BrushHelpers = _objectSpread(_objectSpread({}, Helpers), {}, {
  ...
  onGlobalMouseMove: lodash_throttle__WEBPACK_IMPORTED_MODULE_1___default()(Helpers.onGlobalMouseMove.bind(Helpers), 16, // eslint-disable-line no-magic-numbers
  {
    leading: true,
    trailing: false
  })
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-primitives/rect.js");
/* harmony import */ var _brush_helpers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./brush-helpers */ "../../victory-brush-container/es/brush-helpers.js");
/* harmony import */ var react_fast_compare__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react-fast-compare */ "../../../node_modules/.pnpm/react-fast-compare@3.2.0/node_modules/react-fast-compare/index.js");
/* harmony import */ var react_fast_compare__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react_fast_compare__WEBPACK_IMPORTED_MODULE_2__);
...
function brushContainerMixin(Base) {
  ...
  }(Base), _class.displayName = "VictoryBrushContainer", _class.defaultProps = _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_5__.VictoryContainer.defaultProps), {}, {
    allowDrag: true,
    allowDraw: true,
    allowResize: true,
    brushComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_6__.Rect, null),
    brushStyle: {
      stroke: "transparent",
      fill: "black",
      fillOpacity: 0.1
    },
    handleComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_6__.Rect, null),
    handleStyle: {
      stroke: "transparent",
      fill: "transparent"
    },
...
/* harmony import */ var _victory_primitives_clip_path__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../victory-primitives/clip-path */ "../../victory-core/es/victory-primitives/clip-path.js");
/* harmony import */ var _victory_primitives_circle__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../victory-primitives/circle */ "../../victory-core/es/victory-primitives/circle.js");
/* harmony import */ var _victory_primitives_rect__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../victory-primitives/rect */ "../../victory-core/es/victory-primitives/rect.js");
...
VictoryClipContainer.defaultProps = {
  circleComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_victory_primitives_circle__WEBPACK_IMPORTED_MODULE_6__.Circle, null),
  rectComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_victory_primitives_rect__WEBPACK_IMPORTED_MODULE_7__.Rect, null),
  clipPathComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_victory_primitives_clip_path__WEBPACK_IMPORTED_MODULE_8__.ClipPath, null),
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/selection.js");
...
var CursorHelpersClass = /*#__PURE__*/function () {
  function CursorHelpersClass() {
    ...
    this.handleMouseMove = function (evt, targetProps) {
      ...
      var parentSVG = targetProps.parentSVG || victory_core__WEBPACK_IMPORTED_MODULE_1__.getParentSVG(evt);
      var cursorSVGPosition = victory_core__WEBPACK_IMPORTED_MODULE_1__.getSVGEventCoordinates(evt, parentSVG);
      var cursorValue = victory_core__WEBPACK_IMPORTED_MODULE_1__.getDataCoordinates(targetProps, targetProps.scale, cursorSVGPosition.x, cursorSVGPosition.y);
      ...
      if (victory_core__WEBPACK_IMPORTED_MODULE_2__.isFunction(onCursorChange)) {
        if (cursorValue) {
    ...
    this.onTouchEnd = function (evt, targetProps) {
      ...
      if (victory_core__WEBPACK_IMPORTED_MODULE_2__.isFunction(targetProps.onCursorChange)) {
  ...
  _createClass(CursorHelpersClass, [{
    ...
    value: function withinBounds(point, bounds) {
      var _Helpers$mapValues = victory_core__WEBPACK_IMPORTED_MODULE_2__.mapValues(bounds, Number),
          x1 = _Helpers$mapValues.x1,
          x2 = _Helpers$mapValues.x2,
          y1 = _Helpers$mapValues.y1,
          y2 = _Helpers$mapValues.y2;

      var _Helpers$mapValues2 = victory_core__WEBPACK_IMPORTED_MODULE_2__.mapValues(point, Number),
...
/* harmony import */ var _cursor_helpers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./cursor-helpers */ "../../victory-cursor-container/es/cursor-helpers.js");
...
function cursorContainerMixin(Base) {
  ...
  }(Base), _class.displayName = "VictoryCursorContainer", _class.defaultProps = _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_5__.VictoryContainer.defaultProps), {}, {
    cursorLabelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_6__.VictoryLabel, null),
    cursorLabelOffset: {
      x: 5,
      y: -10
    },
    cursorComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_7__.LineSegment, null)
  }), _class.defaultEvents = function (props) {
    return [{
      target: "parent",
      eventHandlers: {
...
var SelectionHelpersClass = /*#__PURE__*/function () {
  function SelectionHelpersClass() {
    ...
    this.onMouseDown = function (evt, targetProps) {
      ...
      var _Selection$getSVGEven = victory_core__WEBPACK_IMPORTED_MODULE_3__.getSVGEventCoordinates(evt, parentSVG),
          x = _Selection$getSVGEven.x,
          y = _Selection$getSVGEven.y;

      var x1 = polar || dimension !== "y" ? x : victory_core__WEBPACK_IMPORTED_MODULE_3__.getDomainCoordinates(targetProps).x[0];
      var y1 = polar || dimension !== "x" ? y : victory_core__WEBPACK_IMPORTED_MODULE_3__.getDomainCoordinates(targetProps).y[0];
      var x2 = polar || dimension !== "y" ? x : victory_core__WEBPACK_IMPORTED_MODULE_3__.getDomainCoordinates(targetProps).x[1];
      var y2 = polar || dimension !== "x" ? y : victory_core__WEBPACK_IMPORTED_MODULE_3__.getDomainCoordinates(targetProps).y[1];
      var mutatedProps = {
        x1: x1,
        y1: y1,
        select: true,
    ...
    this.handleMouseMove = function (evt, targetProps) {
      ...
      var _Selection$getSVGEven2 = victory_core__WEBPACK_IMPORTED_MODULE_3__.getSVGEventCoordinates(evt, parentSVG),
          x = _Selection$getSVGEven2.x,
          y = _Selection$getSVGEven2.y;
    ...
    this.onMouseUp = function (evt, targetProps) {
      ...
      var bounds = victory_core__WEBPACK_IMPORTED_MODULE_3__.getBounds(targetProps);
      ...
      var callbackMutation = selectedData && victory_core__WEBPACK_IMPORTED_MODULE_4__.isFunction(targetProps.onSelection) ? targetProps.onSelection(selectedData, bounds, lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, mutatedProps, targetProps)) : {};
      var parentMutation = [{
        target: "parent",
        mutation: function () {
          return mutatedProps;
  ...
  _createClass(SelectionHelpersClass, [{
    ...
    value: function getDatasets(props) {
      ...
      var getData = function (childProps) {
        var data = victory_core__WEBPACK_IMPORTED_MODULE_5__.getData(childProps);
      ...
      var iteratee = function (child, childName, parent) {
        ...
        if (!victory_core__WEBPACK_IMPORTED_MODULE_5__.isDataComponent(child) || blacklist.includes(childName)) {
          return null;
    ...
    value: function getSelectedData(props, dataset) {
      ...
      var withinBounds = function (d) {
        var scaledPoint = victory_core__WEBPACK_IMPORTED_MODULE_4__.scalePoint(props, d);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var victory_tooltip__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! victory-tooltip */ "../../victory-tooltip/es/victory-tooltip.js");
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/helpers.js");
  ...
  return _class = /*#__PURE__*/function (_Base) {
    ...
    _createClass(VictoryVoronoiContainer, [{
      ...
      value: function getLabelPosition(props, labelProps, points) {
        ...
        var basePosition = victory_core__WEBPACK_IMPORTED_MODULE_3__.scalePoint(props, point);
      ...
      value: function getStyle(props, points, type) {
        ...
        return points.reduce(function (memo, datum, index) {
          var labelProps = lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, componentProps, {
            datum: datum,
            active: true
          });

          var text = victory_core__WEBPACK_IMPORTED_MODULE_3__.isFunction(labels) ? labels(labelProps) : undefined;
          ...
          var style = victory_core__WEBPACK_IMPORTED_MODULE_3__.evaluateStyle(lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, componentStyle, baseStyle, themeStyles[type]), labelProps);
      ...
      value: function getLabelProps(props, points) {
        ...
        var text = points.reduce(function (memo, datum) {
          ...
          var t = victory_core__WEBPACK_IMPORTED_MODULE_3__.isFunction(labels) ? labels(labelProps) : null;
      ...
      key: "getChildren",
      value: function getChildren(props) {
        return [].concat(_toConsumableArray(react__WEBPACK_IMPORTED_MODULE_2___default().Children.toArray(props.children)), [this.getTooltip(props)]);
      }
    }]);

    return VictoryVoronoiContainer;
  }(Base), _class.displayName = "VictoryVoronoiContainer", _class.defaultProps = _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_4__.VictoryContainer.defaultProps), {}, {
    activateData: true,
    activateLabels: true,
    labelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_tooltip__WEBPACK_IMPORTED_MODULE_5__.VictoryTooltip, null),
    voronoiPadding: 5
  }), _class.defaultEvents = function (props) {
    return [{
      target: "parent",
      eventHandlers: {
        onMouseLeave: function (evt, targetProps) {
          return props.disable ? {} : _voronoi_helpers__WEBPACK_IMPORTED_MODULE_6__.VoronoiHelpers.onMouseLeave(evt, targetProps);
        },
        onTouchCancel: function (evt, targetProps) {
          return props.disable ? {} : _voronoi_helpers__WEBPACK_IMPORTED_MODULE_6__.VoronoiHelpers.onMouseLeave(evt, targetProps);
        },
        onMouseMove: function (evt, targetProps) {
          return props.disable ? {} : _voronoi_helpers__WEBPACK_IMPORTED_MODULE_6__.VoronoiHelpers.onMouseMove(evt, targetProps);
        },
        onTouchMove: function (evt, targetProps) {
          return props.disable ? {} : _voronoi_helpers__WEBPACK_IMPORTED_MODULE_6__.VoronoiHelpers.onMouseMove(evt, targetProps);
        }
...
var VictoryVoronoiContainer = voronoiContainerMixin(victory_core__WEBPACK_IMPORTED_MODULE_4__.VictoryContainer);
...
var VoronoiHelpersClass = /*#__PURE__*/function () {
  function VoronoiHelpersClass() {
    ...
    this.handleMouseMove = function (evt, targetProps) {
      ...
      var mousePosition = victory_core__WEBPACK_IMPORTED_MODULE_6__.getSVGEventCoordinates(evt, parentSVG);
  ...
  _createClass(VoronoiHelpersClass, [{
    ...
    value: function withinBounds(props, point) {
      var width = props.width,
          ...
          origin = props.origin,
          scale = props.scale;
      var padding = victory_core__WEBPACK_IMPORTED_MODULE_7__.getPadding(props, "voronoiPadding");
      var x = point.x,
          y = point.y;
    ...
    value: function getDatasets(props) {
      var minDomain = {
        x: victory_core__WEBPACK_IMPORTED_MODULE_8__.getMinValue(props.domain.x),
        y: victory_core__WEBPACK_IMPORTED_MODULE_8__.getMinValue(props.domain.y)
      };
      var children = react__WEBPACK_IMPORTED_MODULE_5___default().Children.toArray(props.children);
      ...
      var addMeta = function (data, name, child) {
        ...
        return data.map(function (datum, index) {
          var _Helpers$getPoint = victory_core__WEBPACK_IMPORTED_MODULE_7__.getPoint(datum),
              x = _Helpers$getPoint.x,
      ...
      var getData = function (childProps) {
        var data = victory_core__WEBPACK_IMPORTED_MODULE_9__.getData(childProps);
        return Array.isArray(data) && data.length > 0 ? data : undefined;
      };
      ...
      var iteratee = function (child, childName) {
        ...
        if (!victory_core__WEBPACK_IMPORTED_MODULE_9__.isDataComponent(child) || blacklistStr.includes(name) || isRegExpMatch) {
          return null;
        }

        var getChildData = child.type && victory_core__WEBPACK_IMPORTED_MODULE_7__.isFunction(child.type.getData) ? child.type.getData : getData;
        var childData = getChildData(child.props);
        return childData ? addMeta(childData, name, child) : null;
      };

      return victory_core__WEBPACK_IMPORTED_MODULE_7__.reduceChildren(children, iteratee, props);
    }
  }, {
    key: "findPoints",
    ...
    value: function getVoronoiPoints(props, mousePosition) {
      ...
      var scaledData = datasets.map(function (d) {
        var _Helpers$scalePoint = victory_core__WEBPACK_IMPORTED_MODULE_7__.scalePoint(props, d),
            x = _Helpers$scalePoint.x,
            y = _Helpers$scalePoint.y;

        return [x, y];
      });
      var delaunay = delaunay_find_lib_index_js__WEBPACK_IMPORTED_MODULE_4__["default"].from(scaledData);
    ...
    value: function onActivated(props, points) {
      if (victory_core__WEBPACK_IMPORTED_MODULE_7__.isFunction(props.onActivated)) {
    ...
    value: function onDeactivated(props, points) {
      if (victory_core__WEBPACK_IMPORTED_MODULE_7__.isFunction(props.onDeactivated)) {
  ...
  return _class = /*#__PURE__*/function (_Base) {
    ...
    _createClass(VictoryZoomContainer, [{
      ...
      value: function clipDataComponents(children, props) {
        ...
        var groupComponent = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().cloneElement(clipContainerComponent, _objectSpread({
        ...
        return react__WEBPACK_IMPORTED_MODULE_1___default().Children.toArray(children).map(function (child) {
          if (!victory_core__WEBPACK_IMPORTED_MODULE_2__.isDataComponent(child)) {
            return child;
          }
      ...
      value: function downsampleZoomData(props, child, domain) {
        ...
        var getData = function (childProps) {
          var data = childProps.data,
              x = childProps.x,
              y = childProps.y;
          var defaultGetData = child.type && victory_core__WEBPACK_IMPORTED_MODULE_3__.isFunction(child.type.getData) ? child.type.getData : function () {
            return undefined;
        ...
        return victory_core__WEBPACK_IMPORTED_MODULE_2__.downsample(visibleData, maxPoints, startIndex);
      }
    }, {
      key: "modifyChildren",
      value: function modifyChildren(props) {
        ...
        return childComponents.map(function (child) {
          ...
          var isDataComponent = victory_core__WEBPACK_IMPORTED_MODULE_2__.isDataComponent(child);
          var currentDomain = props.currentDomain,
              zoomActive = props.zoomActive,
              allowZoom = props.allowZoom;

          var originalDomain = lodash_defaults__WEBPACK_IMPORTED_MODULE_0___default()({}, props.originalDomain, props.domain);

          var zoomDomain = lodash_defaults__WEBPACK_IMPORTED_MODULE_0___default()({}, props.zoomDomain, props.domain);

          var cachedZoomDomain = lodash_defaults__WEBPACK_IMPORTED_MODULE_0___default()({}, props.cachedZoomDomain, props.domain);
    ...
    clipContainerComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_6__.VictoryClipContainer, null),
    allowPan: true,
    allowZoom: true,
    zoomActive: false
  }), _class.defaultEvents = function (props) {
...
var RawZoomHelpers = {
  ...
  getPosition: function (evt, props, originalDomain) {
    var _Selection$getSVGEven = victory_core__WEBPACK_IMPORTED_MODULE_5__.getSVGEventCoordinates(evt),
        x = _Selection$getSVGEven.x,
        y = _Selection$getSVGEven.y;
  ...
  pan: function (currentDomain, originalDomain, delta) {
    ...
    return victory_core__WEBPACK_IMPORTED_MODULE_4__.containsDates(currentDomain) || victory_core__WEBPACK_IMPORTED_MODULE_4__.containsDates(originalDomain) ? newDomain.map(function (val) {
      return new Date(val);
    }) : newDomain;
  },
  ...
  getDomain: function (props) {
    ...
    var childComponents = react__WEBPACK_IMPORTED_MODULE_3__.Children.toArray(children);
    var childrenDomain = {};

    if (childComponents.length) {
      childrenDomain = zoomDimension ? _defineProperty({}, zoomDimension, victory_core__WEBPACK_IMPORTED_MODULE_6__.getDomainFromChildren(props, zoomDimension, childComponents)) : {
  ...
  onMouseMove: function (evt, targetProps, eventKey, ctx) {
    if (targetProps.panning && targetProps.allowPan) {
      ...
      var _Selection$getSVGEven3 = victory_core__WEBPACK_IMPORTED_MODULE_5__.getSVGEventCoordinates(evt, parentSVG),
...
var ZoomHelpers = {
  ...
  onMouseMove: lodash_throttle__WEBPACK_IMPORTED_MODULE_2___default()(RawZoomHelpers.onMouseMove.bind(RawZoomHelpers), 16, // eslint-disable-line no-magic-numbers
  {
    leading: true,
    trailing: false
  }),
  onWheel: lodash_throttle__WEBPACK_IMPORTED_MODULE_2___default()(RawZoomHelpers.onWheel.bind(RawZoomHelpers), 16, // eslint-disable-line no-magic-numbers
  {
    leading: true,
    trailing: false
  })
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "combineContainerMixins": () => (/* reexport safe */ _create_container__WEBPACK_IMPORTED_MODULE_0__.combineContainerMixins),
/* harmony export */   "createContainer": () => (/* reexport safe */ _create_container__WEBPACK_IMPORTED_MODULE_0__.createContainer),
/* harmony export */   "makeCreateContainerFunction": () => (/* reexport safe */ _create_container__WEBPACK_IMPORTED_MODULE_0__.makeCreateContainerFunction)
/* harmony export */ });
