    ...
    if (arrayX) {
      ...
      return data.map(function (datum) {
        var dataArray = datum[sortKey].map(function (d) {
          return Object.assign({}, datum, _defineProperty({}, sortKey, d));
        });

        var sortedData = lodash_orderBy__WEBPACK_IMPORTED_MODULE_3___default()(dataArray, sortKey);

        return getSummaryStatistics(sortedData);
      });
    } else {
      /* Group data by independent variable and generate summary statistics for each group */
      var groupedData = lodash_groupBy__WEBPACK_IMPORTED_MODULE_0___default()(data, groupKey);

      return Object.keys(groupedData).map(function (key) {
        var datum = groupedData[key];

        var sortedData = lodash_orderBy__WEBPACK_IMPORTED_MODULE_3___default()(datum, sortKey);
...
var getData = function (props) {
  ...
  var formattedData = victory_core__WEBPACK_IMPORTED_MODULE_5__.formatData(props.data, props, accessorTypes);
...
var getStyles = function (props) {
  ...
  var labelStyles = lodash_defaults__WEBPACK_IMPORTED_MODULE_2___default()({}, style.labels, getLabelStyle(props, styleObject));

  var boxStyles = lodash_defaults__WEBPACK_IMPORTED_MODULE_2___default()({}, style.boxes, styleObject.boxes);

  var whiskerStyles = lodash_defaults__WEBPACK_IMPORTED_MODULE_2___default()({}, style.whiskers, styleObject.whiskers);
...
var isDatumOutOfBounds = function (datum, domain) {
  ...
  var _x = datum._x,
      _min = datum._min,
      _max = datum._max;
  var minDomainX = victory_core__WEBPACK_IMPORTED_MODULE_9__.getMinValue(domain.x);
  var maxDomainX = victory_core__WEBPACK_IMPORTED_MODULE_9__.getMaxValue(domain.x);
  var minDomainY = victory_core__WEBPACK_IMPORTED_MODULE_9__.getMinValue(domain.y);
  var maxDomainY = victory_core__WEBPACK_IMPORTED_MODULE_9__.getMaxValue(domain.y);
...
var getBaseProps = function (initialProps, fallbackProps) {
  var modifiedProps = victory_core__WEBPACK_IMPORTED_MODULE_7__.modifyProps(initialProps, fallbackProps, "boxplot");
  ...
  return data.reduce(function (acc, datum, index) {
    var eventKey = !victory_core__WEBPACK_IMPORTED_MODULE_7__.isNil(datum.eventKey) ? datum.eventKey : index;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "VictoryBoxPlot": () => (/* binding */ VictoryBoxPlot)
/* harmony export */ });
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-primitives/border.js");
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-primitives/whisker.js");
...
/* harmony import */ var _helper_methods__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./helper-methods */ "./helper-methods.tsx");
...
var VictoryBoxPlotBase = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(VictoryBoxPlotBase, [{
    ...
    value: function shouldRenderDatum(datum) {
      var hasX = !victory_core__WEBPACK_IMPORTED_MODULE_1__.isNil(datum._x);
      var hasY = !victory_core__WEBPACK_IMPORTED_MODULE_1__.isNil(datum._y);
      var hasSummaryStatistics = !victory_core__WEBPACK_IMPORTED_MODULE_1__.isNil(datum._min) && !victory_core__WEBPACK_IMPORTED_MODULE_1__.isNil(datum._max) && !victory_core__WEBPACK_IMPORTED_MODULE_1__.isNil(datum._median) && !victory_core__WEBPACK_IMPORTED_MODULE_1__.isNil(datum._q1) && !victory_core__WEBPACK_IMPORTED_MODULE_1__.isNil(datum._q3);
...
VictoryBoxPlotBase.defaultTransitions = victory_core__WEBPACK_IMPORTED_MODULE_3__.discreteTransitions();
VictoryBoxPlotBase.defaultProps = {
  ...
  data: defaultData,
  dataComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_5__.Border, null),
  groupComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("g", {
    role: "presentation"
  }),
  maxComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_6__.Whisker, null),
  maxLabelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_7__.VictoryLabel, null),
  medianComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_8__.LineSegment, null),
  medianLabelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_7__.VictoryLabel, null),
  minComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_6__.Whisker, null),
  minLabelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_7__.VictoryLabel, null),
  q1Component: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_5__.Border, null),
  q1LabelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_7__.VictoryLabel, null),
  q3Component: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_5__.Border, null),
  q3LabelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_7__.VictoryLabel, null),
  samples: 50,
  sortKey: "x",
  sortOrder: "ascending",
  standalone: true,
...
VictoryBoxPlotBase.getDomain = _helper_methods__WEBPACK_IMPORTED_MODULE_10__.getDomain;
VictoryBoxPlotBase.getData = _helper_methods__WEBPACK_IMPORTED_MODULE_10__.getData;
...
var VictoryBoxPlot = (0,victory_core__WEBPACK_IMPORTED_MODULE_11__.addEvents)(VictoryBoxPlotBase, options);
...
var evaluateProps = function (props) {
  ...
  var desc = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_1__.evaluateProp(props.desc, props);
  var id = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_1__.evaluateProp(props.id, props);
  var style = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_1__.evaluateStyle(props.style, props);
  var tabIndex = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_1__.evaluateProp(props.tabIndex, props);
  return Object.assign({}, props, {
    ariaLabel: ariaLabel,
    desc: desc,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "VictoryBoxPlot": () => (/* reexport safe */ _victory_box_plot__WEBPACK_IMPORTED_MODULE_0__.VictoryBoxPlot)
/* harmony export */ });
